  ...
  return (
    <footer className="footer">
      ...
      <div className="contenedor-redes">
        <div className="redes">
          <a href="https://github.com/francodessana/AP56G2">
            <img
